...
STRATEGY_GUIDES = {
    "CAPABILITIES_SUMMARY": {
        "title": "🌟 ARUN Bot Capabilities (v2.0)",
    ...
    "BROKER_SETUP": {
        "title": "🔌 Broker Setup (API Keys & Tokens)",
        ...
        "how_it_works": [
            ...
            "2. Create an App (Cost: ₹2000/month).",
    ...
    "CAPITAL_LOGIC": {
        "title": "💰 Capital & Balance Logic",
        "summary": "How the bot handles your money vs. settings.",
        "how_it_works": [
            "CASE 1: Settings (₹1L) < Broker Balance (₹10L)",
            " -> The bot respects your Settings (₹1L). It tracks its own 'Virtual Wallet' and refuses to use more than ₹1L.",
            "",
            "CASE 2: Settings (₹10L) > Broker Balance (₹1L)",
    ...
    "API_CAPABILITIES": {
        "title": "🔌 API Power & Off-Market Checks",
